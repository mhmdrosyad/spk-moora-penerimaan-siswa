            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div id="formTambahData">
                        <form action="<?= base_url('/simpanData'); ?>" method="post">
                            ...
                            <?php foreach ($kriteria as $item) : ?>
                                <div class="form-group">
                                    <label for="kriteria[<?= $item['id']; ?>]"><?= $item['nama_kriteria']; ?>:</label>
                                    <input type="text" id="kriteria[<?= $item['id']; ?>]" name="kriteria[<?= $item['id']; ?>]" class="form-control">
                                </div>
                            <?php endforeach; ?>
